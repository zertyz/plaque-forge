...
pub(crate) use constraints::trajectory_loop_closed;
pub use constraints::{
    apply_motion_scene, apply_visibility_scenes, reapply_locked_scenes, scene_quad,
};
pub use types::{MotionModel, TrackingResult, screen_fixed, select_masked_scene};
...
mod tests {
    use super::{
        ...
        oriented_rect_quad, plaque_feature_mask, plaque_transform_is_valid, reapply_locked_scenes,
        select_masked_scene, solve_unobserved_intervals, static_estimate, surface_visible_fraction,
        trajectory_dynamics, trajectory_loop_closed,
    };
    use crate::{
        color::Rgba,
        geometry::Quad,
