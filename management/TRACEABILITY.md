...
| `E.Seg.03` | `EF.Seg.03-001` | Planned | [src/segmentation_strategy.rs](file:///root/opencode/plaque-forge/src/segmentation_strategy.rs); scene-level model scoping specification |
