...
| `P.VisFid.01` | `PR.VisFid.01-001` | Rolled Out | [src/render/effects/mod.rs](file:///root/opencode/plaque-forge/src/render/effects/mod.rs); [tests/rendering_subsystem.rs](file:///root/opencode/plaque-forge/tests/rendering_subsystem.rs) |
...
| `P.AstNrg.02` | `PN.AstNrg.02-001` | Rolled Out | [src/scene.rs](file:///root/opencode/plaque-forge/src/scene.rs), [src/segmentation_strategy.rs](file:///root/opencode/plaque-forge/src/segmentation_strategy.rs); [tests/scene_regression.rs](file:///root/opencode/plaque-forge/tests/scene_regression.rs) |
...
| `E.Trk.02` | `ER.Trk.02-001` | Rolled Out | [src/analyze/tracking/trajectory.rs](file:///root/opencode/plaque-forge/src/analyze/tracking/trajectory.rs); [tests/tracking_subsystem.rs](file:///root/opencode/plaque-forge/tests/tracking_subsystem.rs) |
...
| `O.CiCd.02` | `ON.CiCd.02-001` | Rolled Out | [scripts/run_homologation_matrix.sh](file:///root/opencode/plaque-forge/scripts/run_homologation_matrix.sh), [.github/workflows/scheduled-homologation-matrix.yml](file:///root/opencode/plaque-forge/.github/workflows/scheduled-homologation-matrix.yml); [tests/cli_workflows.rs](file:///root/opencode/plaque-forge/tests/cli_workflows.rs) |
...
| `O.PyEnv.01` | `OR.PyEnv.01-001` | Rolled Out | [tools/requirements.lock](file:///root/opencode/plaque-forge/tools/requirements.lock), [scripts/setup_segmentation.sh](file:///root/opencode/plaque-forge/scripts/setup_segmentation.sh); [tools/test_segmentation_runtime.py](file:///root/opencode/plaque-forge/tools/test_segmentation_runtime.py) |
