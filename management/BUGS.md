...
Remediation is planned via:
- `EF.Seg.03-001`: Per-scene model and parameter scoping;
- `EN.Hom.02-001`: Establishing formal contracts for the 11 uncontracted scenes;
- `EN.Seg.04-001`: Automated multi-asset regression bake-off gate before model promotion.
